...
augroup MyAutoGroup
    ...
    autocmd BufNewFile,BufRead,BufNew                  *.xaml              setf xml
    autocmd BufNewFile,BufRead,BufNew                  *.{fx,fxc,fxh,hlsl} setf hlsl
    autocmd BufNewFile,BufRead,BufNew                  *.{fsh,vsh}         setf glsl
